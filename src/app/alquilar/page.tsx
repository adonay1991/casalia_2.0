import { Key as KeyIcon } from "@phosphor-icons/react/ssr";
...
export const metadata: Metadata = {
	title: "Alquilar | Propiedades en alquiler en Parla | Casalia",
	description:
		"Encuentra tu vivienda ideal en alquiler en Parla. Pisos, casas, estudios y mas. Gestion profesional de alquileres.",
};

interface AlquilarPageProps {
				...
				<div className="container mx-auto px-4 md:px-6">
					<FadeIn preset="fadeInUp">
						<div className="flex items-center gap-3 mb-4">
							<KeyIcon className="h-8 w-8 text-[var(--casalia-orange)]" />
							<h1 className="text-3xl md:text-4xl font-bold">
								Propiedades en Alquiler
							</h1>
						</div>
						<p className="text-white/80 max-w-2xl">
							Descubre nuestra seleccion de viviendas en alquiler. Gestion
							profesional y atencion personalizada.
						</p>
					</FadeIn>
				</div>
			</section>
				...
				<div className="container mx-auto px-4 md:px-6 py-4">
					<div className="flex flex-wrap items-center justify-between gap-4">
						<Suspense fallback={<div className="h-9" />}>
							<PropertyFilters variant="alquilar" />
						</Suspense>
				...
				<div className="container mx-auto px-4 md:px-6">
					{properties.length > 0 ? (
						...
						<div className="text-center py-16">
							<KeyIcon className="h-16 w-16 mx-auto text-muted-foreground mb-4" />
							...
							<p className="text-muted-foreground">
								{hasFilters
									...
									: "En este momento no tenemos propiedades en alquiler. Vuelve pronto o contactanos para que te avisemos cuando haya nuevas ofertas."}
							</p>
						</div>
					)}
